...
<body>
    ...
    <div class="anhtruong">
		<div class="content-dn" style="top: 0px"> 
			...
			<form id="login-form" action="doimatkhauthongtin.php" method="post" class="loginForm">
                <div id="line-email" class="line">
                    <input id="register_form_email" name="password" type="password" placeholder="Mật khẩu hiện tại" autocorrect="off" autocapitalize="off">
                </div>
				<div id="line-password" class="line">
                    <input id="register_form_password" name="newpassword" type="password" placeholder="Mật khẩu mới">
                </div>
                <div id="line-password-confirm" class="line">
                    <input id="register_form_password_confirm" name="newpassword2"  type="password" placeholder="Nhập lại mật khẩu mới">
                </div>
                <div class="line btnLine">
<input id="confrim-btn" name="login" type="submit" value="Xác nhận"  class="btn">
				</div>
                <div class="divider">
                    Hoặc
                </div>
            ...
            <div class="linkLine">
                <a href="xoaTK.php">Xóa tài khoản</a>
            </div>
		</div>
	</div>
	<div class="footer">
